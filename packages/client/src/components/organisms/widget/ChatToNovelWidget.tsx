...
import { Button, Checkbox, Text, Textarea, useToast } from "@chakra-ui/react"
import { useRecoilState } from "recoil"
import { blocksState } from "../../../recoil/editor"
import { Block, BlockType } from "../../../types/block.type"
import { v4 } from "uuid"

const ChatToNovelWidget: FC = () => {
    ...
    <Widget>
      ...
      <WidgetBody>
        <Textarea
          ...
          value={content}
        />
        <Button isDisabled={!content} gap={3} size={"sm"} onClick={convert}>
          {content ? (
            <>
              <BsDiscord />
              <Text>변환하여 붙여넣기</Text>
        ...
        <Checkbox
          onChange={(e) => setEnableCharacter(e.target.checked)}
          size={"sm"}
        >
          캐릭터 이름 표시하기
        </Checkbox>
