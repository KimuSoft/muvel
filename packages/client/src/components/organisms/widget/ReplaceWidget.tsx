  ...
  return (
    <Widget>
      ...
      <WidgetBody>
        ...
        {regError ? (
          <Text color={useColorModeValue("red.500", "red.200")} fontSize="xs">
            {regError}
          </Text>
        ) : null}
        <HStack gap={4}>
        ...
        <HStack w="100%">
          <Checkbox onChange={(e) => setUseRegex(e.target.checked)} size={"sm"}>
            정규표현식
          </Checkbox>
          <Spacer />
          <Button
