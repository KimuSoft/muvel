...
import { useWidgetOption } from "~/features/editor/widgets/context/WidgetContext" // 리팩토링된 Context 경로
import type { WidgetBaseProps } from "~/features/editor/widgets/components/widgetMap" // Props 타입 경로
