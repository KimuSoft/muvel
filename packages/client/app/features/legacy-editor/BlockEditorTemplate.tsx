...
import EditorHeader from "~/features/legacy-editor/components/organisms/EditorHeader"
import MuvelBlockEditor from "~/features/legacy-editor/components/organisms/MuvelBlockEditor"
      ...
      <Container px={0} w={{ base: "100%", md: "80%" }} maxW={"3xl"} my={30}>
        <Container maxW="3xl" id={"editor-container"}>
          ...
          <Textarea
            ...
            bgColor={{ base: "gray.200", md: "gray.800" }}
            border="none"
            _focus={{ border: "none" }}
            mb={10}
