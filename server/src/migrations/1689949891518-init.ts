...
export class Init1689949891518 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "novel" ADD "thumbnail" character varying`);
        await queryRunner.query(`ALTER TABLE "episode" ADD "episodeType" integer NOT NULL DEFAULT '0'`);
    }
